  ...
  const activities = [
    {
      title: "Robotique",
      description:
        "Construisez et programmez des robots pour participer à des compétitions nationales.",
      icon: Bot,
      image: roboticsImage,
    ...
    },
    {
      ...
      description:
        "Développez votre stratégie et logique à travers des tournois et sessions d'entraînement.",
      icon: Brain,
      image: chessImage,
    ...
    },
    {
      ...
      description:
        "Participez à la compétition du meilleur TIPE et présentez vos travaux de recherche scientifique.",
      icon: Award,
      image: tipeImage,
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl space-y-6">
            ...
            <p className="text-xl text-muted-foreground">
              Stimuler la créativité et l'innovation chez les jeunes esprits à
              travers la science, la technologie et la compétition
              intellectuelle.
            </p>
        ...
        <section className="relative py-16 md:py-20 lg:py-24 overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-black/90 mb-8 max-w-2xl mx-auto font-bold">
              Devenez membre du Club Scientifique et Technologique et participez
              à des projets innovants, des compétitions passionnantes et bien
              plus encore.
            </p>
            <Link to="join">
              <Button
                size="lg"
                className="bg-card text-foreground hover:bg-card/90 shadow-strong"
              >
